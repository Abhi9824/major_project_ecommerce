...
// Add product to cart
export const addToCart = createAsyncThunk('cart/addToCart', async ({ productId, quantity = 1, selectedSize }) => {
  try {
    const response = await axios.post(`http://localhost:3000/cart`, { productId, quantity, selectedSize  });
...
export const updateCartItem = createAsyncThunk("cart/updateCartItem", async ({ id, quantity }) => {
  console.log("Payload: ", { id, quantity });
  try {
